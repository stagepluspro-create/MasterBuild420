    ...
    Tables: {
      ...
      interest_requests: {
        Row: {
          ...
          tool_id: string
          notes: string | null
          status: 'pending' | 'reviewed' | 'implemented' | null
      ...
      spl_measurements: {
        Row: {
          ...
          spl_value: number
          frequency_weighting: 'A' | 'C' | 'Z' | null
          time_weighting: 'Fast' | 'Slow' | 'Impulse' | null
      ...
      inventory_items: {
        Row: {
          ...
          condition: 'new' | 'good' | 'fair' | 'poor' | 'repair' | null
          notes: string | null
          metadata: Json | null
          created_at: string | null
          updated_at: string | null
      ...
      budget_items: {
        Row: {
          ...
          status: 'pending' | 'approved' | 'ordered' | 'received' | 'paid' | null
          notes: string | null
          created_at: string | null
          updated_at: string | null
        }
