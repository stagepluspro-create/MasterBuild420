...
export const tools: ToolConfig[] = [
  ...
  { id: "callsheet", name: "Callsheet Builder", category: "planning", status: "coming_soon", description: "Production callsheets.", icon: "Clipboard", path: "/tools/callsheet", features: [], helpText: "" },
